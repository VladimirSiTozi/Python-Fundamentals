    ...
    if len(my_coffee_in_stock) < n_to_remove:
        ...
        for _ in range(n_to_remove):
            if first_or_last == "first":
                ...
                my_coffee_in_stock.remove(my_coffee_in_stock[-1])
    return my_coffee_in_stock
